...
EXPORT_DECL(MEMHeapHandle, MEMGetBaseHeapHandle, s32 memArena);
...
EXPORT_DECL(u32, MEMGetAllocatableSizeForFrmHeapEx, MEMHeapHandle heap, s32 align);
EXPORT_DECL(void*, MEMAllocFromFrmHeapEx, MEMHeapHandle heap, u32 size, s32 align);
EXPORT_DECL(void, MEMFreeToFrmHeap, MEMHeapHandle heap, s32 mode);
EXPORT_DECL(u32, MEMFreeByStateToFrmHeap, MEMHeapHandle heap, u32 tag);
EXPORT_DECL(u32, MEMRecordStateForFrmHeap, MEMHeapHandle heap, u32 tag);
EXPORT_DECL(void*, MEMAllocFromExpHeapEx, void* heap, u32 size, s32 align);
EXPORT_DECL(void*, MEMCreateExpHeapEx, void* address, u32 size, u16 flags);
EXPORT_DECL(s32, MEMCreateFrmHeapEx, void* address, u32 size, u16 flags);
EXPORT_DECL(void*, MEMDestroyExpHeap, void* heap);
EXPORT_DECL(void, MEMFreeToExpHeap, void* heap, void* ptr);
