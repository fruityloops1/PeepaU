...
void setNerve(IUseNerve* user, const Nerve* nrv);
void setNerveAtStep(IUseNerve* user, const Nerve* nrv, s32 step);
bool isStep(const IUseNerve* user, s32 step);
bool isNerve(const IUseNerve* user, const Nerve* nrv);
s32 getNerveStep(const IUseNerve* user);
const Nerve* getNerve(const IUseNerve* user);
bool isFirstStep(const IUseNerve* user);
bool isLessStep(const IUseNerve* user, s32 cmp);
bool isLessEqualStep(const IUseNerve* user, s32 cmp);
bool isGreaterStep(const IUseNerve* user, s32 cmp);
bool isGreaterEqualStep(const IUseNerve* user, s32 cmp);
