...
public:
    ...
    static T piHalf() { return numbers::pi_vd / static_cast<T>(2); }
    static T pi() { return numbers::pi_vd; }
    static T pi2() { return numbers::pi_vd * static_cast<T>(2); }
    static T zero() { return static_cast<T>(0); }
    static T one() { return static_cast<T>(1); }
    static T ln2() { return numbers::ln2_vd; }
    static T ln2Inv() { return numbers::log2e_vd; }
