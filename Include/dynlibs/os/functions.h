...
#define FLUSH_DATA_BLOCK(addr) asm volatile("dcbf 0, %0; sync" \
                                            :                  \
                                            : "r"(((addr) & ~31)))
#define INVAL_DATA_BLOCK(addr) asm volatile("dcbi 0, %0; sync" \
                                            :                  \
                                            : "r"(((addr) & ~31)))
...
#define OS_FIND_EXPORT(handle, func)              \
...
#define OSScreenSetBuffers(addr)         \
    OSScreenSetBufferEx(0, (void*)addr); \
    OSScreenSetBufferEx(1, (void*)(addr + OSScreenGetBufferSizeEx(0)))
#define OSScreenClearBuffer(temp)   \
    OSScreenClearBufferEx(0, temp); \
    OSScreenClearBufferEx(1, temp)
#define OSScreenFlipBuffers() \
    OSScreenFlipBuffersEx(0); \
    OSScreenFlipBuffersEx(1)
#define OSScreenPutFont(x, y, buf)   \
    OSScreenPutFontEx(0, x, y, buf); \
    OSScreenPutFontEx(1, x, y, buf)
#define OSScreenEnable(enable)   \
    OSScreenEnableEx(0, enable); \
    OSScreenEnableEx(1, enable)
...
extern MEMHeapHandle (*MEMGetBaseHeapHandle)(s32 memArena);
extern u32 (*MEMGetTotalFreeSizeForExpHeap)(s32 heap);
extern u32 (*MEMGetAllocatableSizeForExpHeapEx)(s32 heap, s32 align);
extern u32 (*MEMGetAllocatableSizeForFrmHeapEx)(MEMHeapHandle heap, s32 align);
extern void* (*MEMAllocFromFrmHeapEx)(MEMHeapHandle heap, u32 size, s32 align);
extern void (*MEMFreeToFrmHeap)(MEMHeapHandle heap, s32 mode);
extern u32 (*MEMFreeByStateToFrmHeap)(MEMHeapHandle heap, u32 tag);
extern u32 (*MEMRecordStateForFrmHeap)(MEMHeapHandle heap, u32 tag);
extern void* (*MEMAllocFromExpHeapEx)(void* heap, u32 size, s32 align);
extern void* (*MEMCreateExpHeapEx)(void* address, u32 size, u16 flags);
extern s32 (*MEMCreateFrmHeapEx)(void* address, u32 size, u16 flags);
extern void* (*MEMDestroyExpHeap)(void* heap);
extern void (*MEMFreeToExpHeap)(void* heap, void* ptr);
...
extern void* (*OSBlockMove)(void* dst, const void* src, size_t n, u32 flush);
...
extern s32 (*OSDynLoad_GetModuleName)(s32 handle, char* nameBuffer, s32* nameBufferSize);
